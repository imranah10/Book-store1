      ...
      <div className="max-w-screen-2xl container md:px-20 mt-20 mb-10 px-4 mx-auto flex flex-col md:flex-row dark:mt-0">
        <div className="w-full md:w-1/2 mt-12 md:mt-28 order-2 md:order-1 ">
          <div className="space-y-6">
            ...
            <label className="w-[280px]md:w-[400px] input input-bordered flex items-center gap-2 w-72 md:w-96">
              <svg
          ...
          <button className="btn text-white hover:bg-pink-400 duration-200 bg-pink-600 mt-6">Secondary</button>
        </div>
        <div className="w-full md:w-1/2 mt-12 md:mt-28 order-1">
          <img className="h-92 w-92 rounded-md"
